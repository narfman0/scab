 ...
 * <ul>
 * <li>data/jbt/garbageman.xbt</li>
 * </ul>
 */
public class GarbagemanBT implements jbt.execution.core.IBTLibrary {
	/** Tree generated from file data/jbt/garbageman.xbt. */
				...
				new jbt.model.task.composite.ModelSelector(
						...
						new jbt.model.task.composite.ModelSequence(
								...
								new jbt.model.task.decorator.ModelLimit(
										null,
										1,
										new com.blastedstudios.scab.ai.bt.actions.GMInit(
												null))),
						new jbt.model.task.composite.ModelSequence(
								null,
