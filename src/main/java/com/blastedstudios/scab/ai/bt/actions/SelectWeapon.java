...
//                       DO NOT MODIFY                     
//                                                         
// Generated on 02/25/2015 17:31:00
// ******************************************************* 
package com.blastedstudios.scab.ai.bt.actions;

/** ModelAction class created from MMPM action SelectWeapon. */
public class SelectWeapon extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of SelectWeapon.
	 * 
	 * @param target
	 ...
	 *            retrieved from.
	 */
	public SelectWeapon(jbt.model.core.ModelTask guard, float[] target,
	...
	/**
	 * Returns a com.blastedstudios.scab.ai.bt.actions.execution.SelectWeapon
	 * task that is able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new com.blastedstudios.scab.ai.bt.actions.execution.SelectWeapon(
